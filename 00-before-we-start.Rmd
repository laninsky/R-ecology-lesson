...
I'm going to put the notes that I write in Rstudio up in the etherpad, so don't worry about having to type down everything I type. So here I go switching over.

### OPEN R STUDIO ####

OK, so this little R script I've got going here has our learning objectives for today

To open a new R script, you just click this little drop down menu on the upper left and select R script
...
It can also work with data stored in a bunch of different ways - R can connect to spreadsheets, databases, and other data types on your computer and on the web.
